...
$form = new Application_Form_ImportProductSettingEdit();

define('AKT_PAGE',URL_HOME . 'import_product_setting_edit');

$pagetitle = "Editace definice importu";
...
<div class="wraper">
	...
	<form class="" enctype="application/x-www-form-urlencoded" method="POST">
		<div class="page-header">
			...
			<div class="buttons"><?php print $form->getElement("upd_cat")->render();?></div>
		</div>
