...
//	require_once PATH_ROOT2.'/../inc/init_spolecne.php';
	...
	switch ($action) {
		...
		case "updLicence":
			...
			$formName = "F_LicenceEdit";
			$form = new $formName();
			//Nová sms zpráva
			$modalForm = new BootrapModalForm("myModal",$form);
       $modalForm->closeDisabled = true;
$res .= '<div class="alert alert-warning">Platnost vašeho licenčního čísla vypršela, prosím zadejte nové licenční číslo</div>';
			...
			$res .= '<p>Potřebujete poradit s licencí? Napište na <a href="mailto:info@pivovarcik.cz">info@pivovarcik.cz</a> nebo volejte <a href="tel:+420777029184">777 029 184</a>.</p>';
			$res .= '</div>';
...
<table>
	...
	$upozorneniSystemuA = $SettingsController->getProblemList();
/*
