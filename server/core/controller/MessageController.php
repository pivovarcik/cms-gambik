...
/*
	...
	{
		if($this->getRequest->isPost() && "ins_message" === $this->getRequest->getPost('F_MessageCreate_action', false))
		{
			// načtu Objekt formu
			...
			if ($form->isValid($form->getPost()))
			{
				...
				$entity->adresat_id = $postdata["adresat_id"];
				$entity->autor_id = USER_ID;
				$entity->message = $postdata["message"];
