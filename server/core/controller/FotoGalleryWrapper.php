...
class FotoGalleryWrapper extends G_Wrapper{
	...
	public function __construct($radek)
	{
		...
		if (!empty($radek->file)) {
			...
			$radek->thumb = '<a href="' . URL_IMG . $radek->dir . $radek->file . '"><img src="' . $imageController->get_thumb($radek->dir . $radek->file,$thumb_width,$thumb_height,null,false,true) . '" class="imgobal" /></a>';
