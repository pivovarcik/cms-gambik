 ...
 * */
class F_AdminSettings extends G_Form
{
...
*/
		...
		$value = $this->getPost($name, $set[$name]);
		$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Javascripty v hlavičce:');
		$elem->setAttribs('class','textarea');
		$this->addElement($elem);
		...
		$value = $this->getPost($name, $set[$name]);
		$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Javascripty v patičce:');
		$elem->setAttribs('class','textarea');
		$this->addElement($elem);    
    ...
    $name = "TINY_A_CLASS";
		...
		$value = $this->getPost($name, $set[$name]);
		$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Třídy pro odkazy:');
		$elem->setAttribs('class','textbox');
		$this->addElement($elem);
		...
		$value = $this->getPost($name, $set[$name]);
		$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Favicon 16x16:');
		$elem->setAttribs('class','textbox');
		$this->addElement($elem);

		$name = "SERVER_FAVICON32";
		$elem = new G_Form_Element_Text($name);
		$elem->setAttribs(array("id"=>$name));
		$value = $this->getPost($name, $set[$name]);
		$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Favicon 32x32:');
		$elem->setAttribs('class','textbox');
		$this->addElement($elem);
    
    
    $name = "SERVER_FAVICON96";
		$elem = new G_Form_Element_Text($name);
		$elem->setAttribs(array("id"=>$name));
		$value = $this->getPost($name, $set[$name]);
		$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Favicon 96x96:');
		$elem->setAttribs('class','textbox');
		$this->addElement($elem);
		...
		$elem = new G_Form_Element_Checkbox("THUMB_CROP");
		$elem->setAttribs(array("id"=>"THUMB_CROP"));
		$value = $this->getPost("THUMB_CROP", $set["THUMB_CROP"]);
		$elem->setAttribs('value',1);
		if ($value == 1) {
			$elem->setAttribs('checked','checked');
		}
		...
		//$elem->setAttribs('value',$value);
		$elem->setAttribs('label','oříznutí miniatury');
		//$elem->setAttribs('class','textbox');
		$this->addElement($elem);
...
//		$elem->setAttribs('class','textbox');
		...
		//$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Strukturované ukládání fotek');
		//$elem->setAttribs('class','textbox');
		$this->addElement($elem);
		...
		$value = $this->getPost($name, $set[$name]);
		$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Uživatelský kód v zápatí:');
		$elem->setAttribs('class','textarea');
		$this->addElement($elem);

    $name = "GOOGLE_TAGMANAGER_KEY";
		$elem = new G_Form_Element_Text($name);
		$elem->setAttribs(array("id"=>$name));
		$value = $this->getPost($name, $set[$name]);
		$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Google Tag Manager');
		//		$elem->setAttribs('class','textbox');
		$this->addElement($elem);
    ...
    $name = "GOOGLE_SITE_VERIFICATION";
		...
		$value = $this->getPost($name, $set[$name]);
		$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Google ověření webu');
		//		$elem->setAttribs('class','textbox');
		$this->addElement($elem);
        
    
    
		$platceDaneList = array("0"=>"Nikde","1"=>"V hlavičce","2"=>"V patičce");
		$name = "GOOGLE_TAGMANAGER_POS";
		$elem = new G_Form_Element_Select($name);
		$elem->setAttribs(array("id"=>$name,"required"=>false));
		$value = $this->getPost($name, $set[$name]);
		$elem->setAttribs('value',$value);
		$elem->setAttribs('label','Umístění na stránce');
		$pole = array();
