...
class GModel{
   ...
   /**
    ...
    SELECT * FROM `mm_umisteni_foto` 
left join mm_products on mm_umisteni_foto.uid_target=mm_products.id
WHERE `table`='mm_products' and (mm_products.isDeleted=1 or mm_products.id is null)
    ...
    **/
	...
	function __construct(){
		...
		$this->version_date = date("2018-07-09");
		$this->version = 5.007;
		$this->upsize = 13;   // TODO nevím, zda toto číslo měnit pro nové instalace
	...
	public function zalozTable($entitaName,$drop = false)
	{
		...
		foreach ($entita->getMetadata() as  $property => $definition) {
			...
			if ($property == $entita->getPrimary()) {
				...
				if (isset($definition["default"]) && (!isset($definition["stereotyp"]) || isset($definition["stereotyp"]) && $definition["stereotyp"] != "vypoctova")) {
		...
		$res .= ')';
		$res .= 'ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1;';

		
    if (!$this->sql->query($res))
    {
           //   $this->sql->query($res);
           		print '* Tabulka ' . $entita->getTablename() . ' - nebyla vygenerovana!'. "<br />";
		print "<pre>";
    print $res;
...
if (file_exists($path)) {
	...
	private function createFulltextIndex($zdrojTabulka,$zdrojPolozka)
	{
	   //ALTER TABLE `mp3` ADD FULLTEXT KEY `song2` (`song2`);
  	$query = "ALTER TABLE `" . $zdrojTabulka . "` ADD FULLTEXT KEY `" . $zdrojPolozka  . "` (`" . $zdrojPolozka  . "`);";
		$this->sql->query($query);

		$this->createConstraintLog .= "-- Zakládám fulltext index pro " . $zdrojPolozka . " (" . $zdrojTabulka . "):" . "\n" . $query . "\n";
	}
	...
	public function validTable($entitaName)
	{
		...
		foreach ($metadata as  $property => $definition) {
			...
			if (!isset($tableSchema[$property])) {
				...
				$vypoctova = isset($definition["stereotyp"]) ? ($definition["stereotyp"]) : "";
				if (isset($definition["default"]) && $vypoctova != "vypoctova") {
					if (trim(strtoupper($definition["default"])) == "NOT NULL") {
						$res .= ' NOT NULL';
					} else {
						$res .= ' DEFAULT ' . $definition["default"];
...
<column name="h_total_rating" header="Heureka" class="text" order="29" visibility="0"/>
</definition>';
		array_push($filterViewDefinitionData, $data);
...
<column name="group_label" header="Skupiny" class="text" order="4" visibility="1"/>
...
<column name="reference" header="Importní kód" class="code" order="28" visibility="0"/>
...
<column name="stav_qty" header="Stav" class="code" order="1" visibility="0"/>
<column name="rozmer" header="Rozměr" class="code" order="1" visibility="0"/>
<column name="objem" header="Objem" class="code" order="1" visibility="0"/>
<column name="import_id" header="Import Id" class="code" order="1" visibility="0"/>
<column name="import_category" header="Import kat." class="code" order="1" visibility="0"/>
</definition>';
		array_push($filterViewDefinitionData, $data);
		...
		$data = array();
		$data["modelname"] = "ProductAttributes";
		$data["isDefault"] = 1;
		$data["definition"] = '<definition><column name="description" header="" class="icon" order="2" visibility="1"/><column name="name" header="Název" class="text" order="1" visibility="1"/><column name="parent_name" header="Nadřízený" class="text" order="3" visibility="1"/><column name="TimeStamp" header="Vloženo" class="datetime" order="7" visibility="1"/></definition>';
		array_push($filterViewDefinitionData, $data);
		...
		$data["isDefault"] = 1;
		$data["definition"] = '<definition><column name="aktivni" header="Akt." class="checkbox" order="1" visibility="1"/><column name="name" header="Název" class="text" order="1" visibility="1"/><column name="description" header="" class="icon" order="2" visibility="1"/><column name="price_value" header="Cena popis" class="text" order="3" visibility="1"/><column name="price" header="Cena" class="money" order="4" visibility="1"/><column name="osobni_odber" header="Odběrné místo" class="checkbox" order="5" visibility="1"/><column name="TimeStamp" header="Vloženo" class="datetime" order="7" visibility="1"/></definition>';
		array_push($filterViewDefinitionData, $data);

		$data = array();
		$data["modelname"] = "Platba";
		$data["isDefault"] = 1;
		$data["definition"] = '<definition><column name="aktivni" header="Akt." class="checkbox" order="1" visibility="1"/><column name="name" header="Název" class="text" order="1" visibility="1"/><column name="description" header="" class="icon" order="2" visibility="1"/><column name="TimeStamp" header="Vloženo" class="datetime" order="7" visibility="1"/></definition>';
		array_push($filterViewDefinitionData, $data);
...
<column name="id" header="ID" class="code" order="1" visibility="1"/>
<column name="name" header="Název" class="" order="2" visibility="1"/>
<column name="price" header="Cena" class="money" order="3" visibility="1"/>
<column name="price_sdani" header="Cena s DPH" class="money" order="3" visibility="1"/>
<column name="dph_name" header="DPH" class="numeric" order="4" visibility="1"/>
...
<column name="nazev_dostupnost" header="Dostupnost" class="" order="5" visibility="1"/>
<column name="stav_qty" header="Akt. stav" class="" order="5" visibility="1"/>
<column name="stav_qty_min" header="Min. stav" class="" order="5" visibility="0"/>
<column name="stav_qty_max" header="Max. stav" class="" order="5" visibility="0"/>
<column name="TimeStamp" header="Vloženo" class="datetime" order="8" visibility="1"/>
</definition>';
		array_push($filterViewDefinitionData, $data);
		...
		$data["isDefault"] = 1;
		$data["definition"] = '<definition><column name="label" header="Text" class="" order="1" visibility="1"/><column name="status" header="Stav" class="code" order="1" visibility="1"/><column name="method" header="Metoda" class="code" order="1" visibility="1"/><column name="transId" header="ID transakce" class="" order="1" visibility="1"/><column name="code" header="Var. symbol" class="code" order="1" visibility="1"/><column name="amount" header="Částka" class="money" order="3" visibility="1"/><column name="TimeStamp" header="Vloženo" class="datetime" order="4" visibility="1"/></definition>';
		array_push($filterViewDefinitionData, $data);
...
<column name="prodcena_sdph" header="Zákl. cena s DPH" class="money" order="4" visibility="1" edit="0"/>
<column name="cenik_cena" header="Pevná cena" class="money" order="5" visibility="0" edit="0"/>
<column name="vypocet_cena" header="Prod. cena" class="money" order="5" visibility="1" edit="0"/>
<column name="vypocet_cena_sdph" header="Prod. cena s DPH" class="money" order="5" visibility="1" edit="0"/>
<column name="nakupni_cena" header="Nákupní cena" class="money" order="5" visibility="1" edit="0"/>
<column name="marze" header="Marže %" class="money" order="5" visibility="1" edit="0"/>
<column name="sleva" header="Sleva" class="money" order="6" visibility="1" edit="0"/>
<column name="typ_slevy" header="Druh slevy" class="" order="7" visibility="1" edit="1"/>
<column name="platnost_od" header="Platná od" class="datetime" order="8" visibility="1" edit="0"/>
<column name="platnost_do" header="Platná do" class="datetime" order="9" visibility="1" edit="0"/>
...
<column name="sync_stav" header="Syn. stav" class="checkbox" order="2" visibility="1"/>
<column name="sync_price" header="Syn. cenu" class="checkbox" order="2" visibility="1"/>
<column name="sync_aktivni" header="Syn. akt./neakt." class="checkbox" order="2" visibility="1"/>
<column name="deactive_product" header="Deaktivovat" class="checkbox" order="2" visibility="1"/>
<column name="import_product_is_active" header="Aktivovat" class="checkbox" order="2" visibility="1"/>
<column name="import_images" header="Import. obrázky" class="checkbox" order="2" visibility="1"/>
<column name="import_reference" header="Identifikátor" class="" order="2" visibility="1"/>
<column name="shop_items" header="Hlavní node" class="" order="2" visibility="1"/>
<column name="block_size" header="Velikost bloku" class="" order="2" visibility="1"/>
<column name="cron_hodina" header="Hodina" class="" order="2" visibility="1"/>
<column name="syncLastTimeStamp" header="Poslední syn." class="datetime" order="2" visibility="1"/>
...
<column name="TimeStamp" header="Vloženo" class="datetime" order="7" visibility="1"/>
		...
		$data["definition"] = '<definition>
<column name="thumb" header="Náhled" class="thumb" order="1" visibility="1"/>
<column name="product_code" header="Číslo" class="code" order="2" visibility="1"/>
<column name="product_name" header="Název" class="text" order="3" visibility="1"/>
<column name="qty" header="Množství" class="money" order="4" visibility="1"/>
<column name="price" header="Prodejní cena" class="money" order="5" visibility="1"/>
<column name="price_sdani" header="Prodejní cena s DPH" class="money" order="6" visibility="1"/>
<column name="basket_sleva" header="Sleva" class="money" order="7" visibility="1"/>
<column name="basket_typ_slevy" header="Typ slevy" class="code" order="8" visibility="1"/>
<column name="nick" header="Uživatel" class="text" order="9" visibility="1"/>
<column name="nazev_category" header="Umístění" class="code" order="3" visibility="0"/>
<column name="ip_adresa" header="IP" class="text" order="11" visibility="1"/>
<column name="nazev_vyrobce" header="Značka" class="text" order="12" visibility="1"/>
<column name="TimeStamp" header="Vloženo" class="datetime" order="13" visibility="1"/>
<column name="basket_id" header="Košík Id" class="code" order="10" visibility="1"/>
<column name="ChangeTimeStamp" header="Upraveno" class="datetime" order="14" visibility="0"/>
...
$data["definition"] = '<definition>
		...
		array_push($filterViewDefinitionData, $data);
    		...
    		$data = array();
		$data["modelname"] = "ProductPohyb";
		$data["isDefault"] = 1;
		$data["definition"] = '<definition>
    <column name="TimeStamp" header="Kdy" class="datetime" order="8" visibility="1"/>
    <column name="mnozstvi" header="Množství" class="money" order="7" visibility="1"/>
<column name="price" header="Prodejní cena" class="money" order="6" visibility="1"/>
<column name="price_sdani" header="Prodejní cena s DPH" class="money" order="6" visibility="1"/>
<column name="description" header="Pozn." class="code" order="1" visibility="1"/>
<column name="title" header="Název" class="text" order="2" visibility="1"/>
<column name="objednavka_code" header="Objednávka" class="code" order="3" visibility="1"/>
</definition>';
		array_push($filterViewDefinitionData, $data);
                                       
                                       
                                       $data = array();
$data["modelname"] = "Newsletter";
$data["isDefault"] = 1;
$data["definition"] = '<definition>
		<column name="name" header="Název" class="" order="1" visibility="1"/>
		<column name="subject" header="Předmět" class="" order="1" visibility="1"/>
		<column name="TimeStamp" header="Vloženo" class="datetime" order="4" visibility="1"/>
</definition>';
		array_push($filterViewDefinitionData, $data);
...
$data["isDefault"] = 1;
$data["definition"] = '<definition>
		<column name="subject" header="Účel" class="" order="1" visibility="1"/>
		<column name="email" header="Email" class="" order="1" visibility="1"/>
		<column name="souhlas_od" header="Od" class="datetime" order="1" visibility="1"/>
		<column name="souhlas_do" header="Od" class="datetime" order="1" visibility="1"/>
		<column name="TimeStamp" header="Vloženo" class="datetime" order="4" visibility="1"/>
</definition>';
		array_push($filterViewDefinitionData, $data);
	...
	private function getUpsize()
	{
		...
		if ($upsizeNovy > $upsize) {


    
    			// Opravný script pro dopčet ceny s dph
			$sql = "update`mm_products_version` pv left join mm_products p on p.id=pv.page_id and p.version=pv.version 
left join mm_dph d on d.id=p.dph_id
				set pv.prodcena_sdph = round(pv.prodcena * (100+d.value)/100,2)
        where d.value is not null and pv.prodcena <> 0 and pv.prodcena_sdph=0
			...
			$sql = "update `" . T_OPTIONS . "` set `value` = '" . $upsizeNovy . "' where  `key` ='UPSIZE'";
			$this->sql->get_row($sql);
	...
	$upsizeNovy++;
		if ($upsizeNovy > $upsize) {
			...
			for($i=0; $i<count($list);$i++) {
				...
				$sql = "update `" . T_TAGS . "` set `url` = '" . strToUrl($list[$i]->name) . "' where  `id` =" . $list[$i]->id;
				$this->sql->get_row($sql);
		...
		if ($upsizeNovy > $upsize) {
			...
			for($i=0; $i<count($list);$i++) {
				...
				$sql = "insert into mm_product_group_assoc (product_id, group_id) SELECT id,skupina_id FROM `mm_products` where isDeleted=0 and skupina_id is not null and id not in (select product_id from  `mm_product_group_assoc` )";
				$this->sql->get_row($sql);
      ...
      $sql = "update
mm_products 
left join `mm_product_group_assoc` on mm_products.id=mm_product_group_assoc.product_id
left join mm_shop_skupiny on mm_shop_skupiny.id=mm_product_group_assoc.group_id
set mm_products.group_label=mm_shop_skupiny.name,
mm_products.group_id=mm_shop_skupiny.id  ";
				$this->sql->get_row($sql);
        
      				$sql = "update mm_products set skupina_id =  null";
				$this->sql->get_row($sql);
		...
		if ($upsizeNovy > $upsize) {
				...
				$sql = "update mm_language set currency =  'Kč',kurz=1 where id=6 and currency is null";
				$this->sql->get_row($sql);

				$sql = "update mm_language set currency =  'Eur',kurz=27  where id=2 and currency is null";
				$this->sql->get_row($sql);
        ...
        $args = new ListArgs();
        $args->limit = 10000;
        $Faktury = new models_Faktury();
        $list = $Faktury->getList($args);
        
        foreach($list as $row)
        {
           $Faktury->updateRecords($Faktury->getTablename(),array("download_hash"=> strtolower(substr(md5(rand()),0,50))),"id=" . $row->id);
        }

        $Faktury = new models_Orders();
        $list = $Faktury->getList($args);
    ...
    $upsizeNovy++;
        ...
        for ($i=0;$i<count($list);$i++)
        {
            ...
            // Verzování dle jazyků
                ...
                $model->insertRecords(T_MJ_VERSION,array("name"=> $list[$i]->name,"mj_id" => $list[$i]->id,"lang_id" => $val->id));
            ...
            // Dostupnost do DostupnostVersion
    $upsizeNovy++;
		if ($upsizeNovy > $upsize) {
      print "Upsize: " . $upsizeNovy . "<br />";
        ...
        /*					$args = new ListArgs();
				...
				//	$args->lang = $val->code;
					$list = $model->getList($args);
          */
          		$sql = "SELECT * FROM `" . T_PRODUCT_DOSTUPNOST . "";
		$list = $this->sql->get_results($sql);
        ...
        for ($i=0;$i<count($list);$i++)
        {
            ...
            // Verzování dle jazyků
    				foreach ($languageList as $key => $val){
                $model->insertRecords(T_PRODUCT_DOSTUPNOST_VERSION,array("name"=> $list[$i]->name,"dostupnost_id" => $list[$i]->id,"lang_id" => $val->id));
    ...
    $upsizeNovy++;
     ...
     //SELECT qty*-1,product_id,varianty_id,user_id,sleva,typ_slevy,price,price_sdani,celkem, celkem_sdani,TimeStamp,tax_id FROM `mm_shop_order_details` where product_id is not null 
				$sql = "insert into " . T_PRODUCT_POHYB . " (mnozstvi,product_id,varianty_id,user_id,sleva,typ_slevy,price,price_sdani,celkem, celkem_sdani,datum,tax_id,TimeStamp,ChangeTimeStamp,doklad_id,radek_id) SELECT qty*-1,product_id,varianty_id,user_id,sleva,typ_slevy,price,price_sdani,celkem, celkem_sdani,TimeStamp,tax_id,now(),now(),doklad_id,id FROM `mm_shop_order_details` where product_id is not null";
				$this->sql->get_row($sql);
		...
		if ($upsizeNovy > $upsize) {
         print "Upsize: " . $upsizeNovy . "<br />";
            ...
            $sql = "update " . T_SHOP_PRODUCT . " left join  (
				SELECT product_id,sum(qty) as mnozstvi FROM `" . T_SHOP_ORDER_DETAILS ."` where product_id is not null and varianty_id is null and isDeleted=0
				group by product_id) v on `" . T_SHOP_PRODUCT . "`.id = v.product_id 
				set stav_qty = v.mnozstvi * -1
				where isDeleted=0";
  			$this->sql->query($sql);
  //   print $model->getLastQuery() . "<br />";     
      //$model->commit ? null : $all_query_ok = false;  
			...
			SELECT varianty_id,sum(qty) as mnozstvi FROM `" . T_SHOP_ORDER_DETAILS ."` where  product_id is not null and varianty_id is not null and isDeleted=0
        ...
        //insert into `mm_product_attributes_version` (name,lang_id,attrib_id) select name,6,id from `mm_product_attributes` 
...
" . $this->url_home_rel . "public/js/main.js";
		...
		$demodata["SERVER_FAVICON32"] = "";
		$demodata["SERVER_FAVICON96"] = "";
		$demodata["TINY_CSS"] = '* {
...
+ "textarea[cols|rows|disabled|name|readonly],tt,var,big,iframe[src|width|height]';
		...
		$demodata["FOOTER_CODE"] = "";

		$demodata["EMAIL_ERROR"] = "!";


    		$demodata["GOOGLE_TAGMANAGER_KEY"] = "";
    		$demodata["GOOGLE_SITE_VERIFICATION"] = "";
		$demodata["GOOGLE_TAGMANAGER_POS"] = "1";
		$demodata["GOOGLE_ANALYTICS_POS"] = "1";
		$demodata["TINY_A_CLASS"] = "Lightbox,lightbox";
    
    $demodata["SERVER_JS_FOOT"] = "";
    $demodata["THUMB_CROP"] = "0";
...
zasíláme potrvrzení o přijetí objednávky.";
    ...
    $demodata["GPWP_TEST"] = "0";
		$demodata["GPWP_URL"] = "";
		$demodata["GPWP_MERCHANT"] = "";
		$demodata["GPWP_SECRET"] = "";
    $demodata["GPWP_SECRET_TEST"] = "";
    $demodata["GPWP_PUBLIC_KEY"] = "";
    $demodata["GPWP_PUBLIC_KEY_TEST"] = "";

    $demodata["GPWP_PRIVATE_KEY"] = "";
    $demodata["GPWP_PRIVATE_KEY_TEST"] = "";    
    ...
    Zkuste obecnější dotaz.</p>';
		...
		$demodata["CENIK_ID"] = "0";
		$demodata["OP_PDF"] = "0";
		$demodata["OP_PDF_FILE"] = "";


		$demodata["HEUREKA_RECENZE_CRON"] = "99";
		$demodata["HEUREKA_CRON_DATE"] = "";

    $demodata["ZBOZICZ_EXPORT_CRON"] = "99";
    $demodata["FAVI_EXPORT_CRON"] = "99";
    $demodata["POHODA_OBJ_XML_DATE"] = "";
    $demodata["POHODA_OBJ_XML_FDATE"] = "";
    $demodata["POHODA_OBJ_XML_TDATE"] = "";
    $demodata["POHODA_OBJ_XML_FCODE"] = "";
    $demodata["POHODA_OBJ_XML_TCODE"] = "";
        $demodata["POHODA_OBJ_XML_STAV"] = "";
        
    $demodata["POHODA_FAK_XML_DATE"] = "";
    $demodata["POHODA_FAK_XML_FDATE"] = "";
    $demodata["POHODA_FAK_XML_TDATE"] = "";
    $demodata["POHODA_FAK_XML_FCODE"] = "";
    $demodata["POHODA_FAK_XML_TCODE"] = "";
    $demodata["POHODA_ZBOZI_XML_DATE"] = "";
    $demodata["POHODA_ZBOZI_XML_SKLAD"] = "";
    
    $demodata["ZBOZICZ_XML_DATE"] = "";
    $demodata["FAVI_XML_DATE"] = "";

    $demodata["HEUREKA_XML_DATE"] = "";
    
    $demodata["ADD_BASKET_BEZSTAVU"] = "1";

    $demodata["POHODA_EXP_USER"] = "";
    $demodata["POHODA_EXP_PWD"] = "";

    $demodata["FAVI_KOD_DOPRAVCE"] = "";
    $demodata["FAVI_CENA_DOPRAVCE"] = "";
    $demodata["HEUREKA_EXPORT_CRON"] = "99";
    $demodata["PRODUCT_IMG_ZIP_DATE"] = "";
    
    
    
    
    $demodata["CISLO01_ID"] = "0";
		$demodata["CISLO02_ID"] = "0";
		$demodata["CISLO03_ID"] = "0";
		$demodata["CISLO04_ID"] = "0";
		$demodata["CISLO05_ID"] = "0";
		$demodata["CISLO06_ID"] = "0";
		$demodata["CISLO07_ID"] = "0";
		$demodata["CISLO08_ID"] = "0";
		$demodata["CISLO09_ID"] = "0";
		$demodata["CISLO10_ID"] = "0";
    
		$demodata["POLOZKA01_ID"] = "0";
		$demodata["POLOZKA02_ID"] = "0";
		$demodata["POLOZKA03_ID"] = "0";
		$demodata["POLOZKA04_ID"] = "0";
		$demodata["POLOZKA05_ID"] = "0";
		$demodata["POLOZKA06_ID"] = "0";
		$demodata["POLOZKA07_ID"] = "0";
		$demodata["POLOZKA08_ID"] = "0";
		$demodata["POLOZKA09_ID"] = "0";
		$demodata["POLOZKA10_ID"] = "0";
		$demodata["BASKET_REDIRECT"] = "0";
    
    
    
    $demodata["CISLO01_SECRET"] = "0";
		$demodata["CISLO02_SECRET"] = "0";
		$demodata["CISLO03_SECRET"] = "0";
		$demodata["CISLO04_SECRET"] = "0";
		$demodata["CISLO05_SECRET"] = "0";
		$demodata["CISLO06_SECRET"] = "0";
		$demodata["CISLO07_SECRET"] = "0";
		$demodata["CISLO08_SECRET"] = "0";
		$demodata["CISLO09_SECRET"] = "0";
		$demodata["CISLO10_SECRET"] = "0";
    
    
		$demodata["POLOZKA01_SECRET"] = "0";
		$demodata["POLOZKA02_SECRET"] = "0";
		$demodata["POLOZKA03_SECRET"] = "0";
		$demodata["POLOZKA04_SECRET"] = "0";
		$demodata["POLOZKA05_SECRET"] = "0";

		$demodata["POLOZKA06_SECRET"] = "0";
		$demodata["POLOZKA07_SECRET"] = "0";
		$demodata["POLOZKA08_SECRET"] = "0";
		$demodata["POLOZKA09_SECRET"] = "0";
		$demodata["POLOZKA10_SECRET"] = "0";
		$demodata["RAZITKO_PDF_FILE"] = "";
	...
	public function insert_syscategory(){
		...
		*/
		...
		$this->addSysCategory("GDPR","gdpr",$nastaveniId,"");
	}
...
*/
    ...
    $data = array();
		...
		$data["lang_id"] = 6;
		$data["mj_id"] = $id;
    $model->insertRecords(T_MJ_VERSION,$data);
...
//		$data["name"] = "l";
	...
	private function insert_mesta(){
		...
		$query = "INSERT INTO `" . T_MESTA . "` (`id`, `obec`, `okres_id`) VALUES
...
(1, 0, '2013-02-19 22:03:24', '2013-05-03 14:30:56', 'kosik_je_prazdny'),
(2, 0, '2013-02-19 22:33:37', '2013-02-19 22:33:37', 'kod_zbozi'),
(3, 0, '2013-02-19 22:34:56', '2013-02-19 22:34:56', 'detail'),
(4, 0, '2013-02-19 22:35:49', '2013-02-19 22:35:49', 'znacka_value'),
(5, 0, '2013-02-19 22:57:54', '2013-02-19 22:57:54', 'popis'),
(6, 0, '2013-02-19 22:58:12', '2017-10-05 21:01:31', 'dostupnost'),
(7, 0, '2013-02-19 22:58:18', '2013-02-19 22:58:18', 'zaruka'),
(8, 0, '2013-02-19 22:58:26', '2013-02-19 22:58:26', 'cena_bezdph'),
(9, 0, '2013-02-19 22:58:59', '2013-02-19 22:58:59', 'celkova_cena'),
(10, 0, '2013-02-19 22:59:47', '2013-02-19 23:02:22', 'do_kosiku_uspesne_pridano'),
(11, 0, '2013-02-19 23:00:08', '2013-02-19 23:00:08', 'koupit'),
(12, 0, '2013-02-19 23:03:21', '2013-02-19 23:03:21', 'pokracovat_v_nakupu'),
(13, 0, '2013-02-19 23:03:34', '2013-02-19 23:03:34', 'prejit_do_kosiku'),
(14, 0, '2013-02-19 23:04:04', '2013-02-19 23:04:04', 'nakupni_kosik'),
(15, 0, '2013-02-19 23:04:53', '2013-02-19 23:06:45', 'kontrola_hodnot_kosiku'),
(16, 0, '2013-02-19 23:06:58', '2013-02-19 23:06:58', 'product'),
(17, 0, '2013-02-19 23:07:39', '2013-04-21 17:34:33', 'cena_za_jednotku'),
(6, 0, '2013-02-19 22:58:12', '2017-10-05 21:01:31', 'Dostupnost', 6, 6),
(7, 0, '2013-02-19 22:58:18', '2013-02-19 22:58:18', 'Záruka', 6, 7),
(8, 0, '2013-02-19 22:58:26', '2013-02-19 22:58:26', 'Cena bez DPH', 6, 8),
(9, 0, '2013-02-19 22:58:59', '2013-02-19 22:58:59', 'Cena s DPH', 6, 9),
(10, 0, '2013-02-19 22:59:47', '2013-02-19 23:02:22', 'Zboží bylo přidáno do košíku', 6, 10),
(11, 0, '2013-02-19 23:00:08', '2013-02-19 23:00:08', 'Koupit', 6, 11),
(12, 0, '2013-02-19 23:03:21', '2013-02-19 23:03:21', 'Pokračovat v nákupu', 6, 12),
(13, 0, '2013-02-19 23:03:34', '2013-02-19 23:03:34', 'Přejít do košíku', 6, 13),
(14, 0, '2013-02-19 23:04:04', '2013-02-19 23:04:04', 'Obsah nákupního košíku', 6, 14),
(15, 0, '2013-02-19 23:04:53', '2013-02-19 23:06:45', 'Prosíme Vás překontrolujte si Vámi vybrané zboží!', 6, 15),
(16, 0, '2013-02-19 23:06:58', '2013-02-19 23:06:58', 'Název zboží', 6, 16),
(17, 0, '2013-02-19 23:07:39', '2013-04-21 17:34:33', 'Cena / MJ', 6, 17),
(18, 0, '2013-02-19 23:07:54', '2013-04-21 17:34:07', 'Množství', 6, 18),
(19, 0, '2013-02-19 23:10:37', '2013-06-08 21:33:46', 'Celkem Kč', 6, 19),
(20, 0, '2013-02-19 23:10:53', '2013-02-19 23:10:53', 'změnit', 6, 20),
(21, 0, '2013-02-19 23:11:59', '2013-02-19 23:11:59', 'Dopravné', 6, 21),
(22, 0, '2013-02-19 23:12:35', '2013-05-04 17:28:24', 'K úhradě', 6, 22),
(23, 0, '2013-02-19 23:13:11', '2013-02-19 23:13:11', 'Vyprázdnit košík', 6, 23),
(24, 0, '2013-02-19 23:13:40', '2013-06-02 16:13:37', 'Pokračovat k pokladně', 6, 24),
(25, 0, '2013-02-19 23:14:30', '2013-02-19 23:14:30', 'Odebrat zboží z košíku?', 6, 25),
(26, 0, '2013-02-19 23:15:14', '2013-02-19 23:15:14', 'Váš košík je prázdný!', 6, 26),
(27, 0, '2013-02-19 23:17:00', '2013-04-29 23:25:06', 'Způsob dopravy', 6, 27),
(28, 0, '2013-02-19 23:17:46', '2013-02-19 23:17:46', 'Zvolte způsob platby', 6, 28),
(29, 0, '2013-02-19 23:18:18', '2013-04-29 23:25:26', 'Způsob platby', 6, 29),
(30, 0, '2013-02-19 23:19:52', '2013-02-19 23:19:52', 'Zpět na výběr dopravy', 6, 30),
(31, 0, '2013-02-19 23:20:45', '2013-04-21 17:44:30', 'Rekapitulace - Dokončení objednávky', 6, 31),
(32, 0, '2013-02-19 23:22:04', '2013-02-19 23:23:15', 'Dodací adresu vyplňte v případě, že se obě liší!', 6, 32),
(33, 0, '2013-02-19 23:23:40', '2013-02-19 23:23:40', 'Fakturační adresa', 6, 33),
(34, 0, '2013-02-19 23:23:59', '2013-05-20 17:58:13', 'Jméno a Příjmení / Firma', 6, 34),
(35, 0, '2013-02-19 23:24:36', '2013-02-19 23:24:36', 'Kontaktní osoba', 6, 35),
(36, 0, '2013-02-19 23:24:57', '2013-02-19 23:24:57', 'Ulice, č.p.', 6, 36),
(37, 0, '2013-02-19 23:25:12', '2013-02-19 23:25:12', 'Město', 6, 37),
(38, 0, '2013-02-19 23:25:23', '2013-02-19 23:25:23', 'PSČ', 6, 38),
(39, 0, '2013-02-19 23:25:42', '2013-02-19 23:25:42', 'Telefon (+420 XXX XXX XXX)', 6, 39),
(40, 0, '2013-02-19 23:25:56', '2013-02-19 23:26:08', 'E-mail', 6, 40),
(41, 0, '2013-02-19 23:26:22', '2013-02-19 23:26:22', 'IČ', 6, 41),
(42, 0, '2013-02-19 23:26:30', '2013-02-19 23:26:30', 'DIČ', 6, 42),
(43, 0, '2013-02-19 23:26:46', '2013-02-19 23:26:46', 'Dodací adresa', 6, 43),
(44, 0, '2013-02-19 23:28:20', '2013-02-19 23:28:20', 'Dokončit objednávku', 6, 44),
(45, 0, '2013-02-19 23:37:15', '2013-02-19 23:37:15', 'Položek v košíku', 6, 45),
(46, 0, '2013-02-19 23:38:04', '2013-02-19 23:40:10', 'Celkem', 6, 46),
(47, 0, '2013-02-25 18:23:18', '2013-02-25 18:23:18', 'Parametry zboží', 6, 47),
(48, 0, '2013-03-03 11:56:29', '2013-03-03 11:56:29', 'Přijatá objednávka', 6, 48),
(49, 0, '2013-03-03 11:56:42', '2013-03-03 11:56:42', 'Dodavatel', 6, 49),
(50, 0, '2013-03-03 11:56:51', '2013-03-03 11:56:51', 'Odběratel', 6, 50),
(51, 0, '2013-03-03 11:57:10', '2013-03-03 11:57:10', 'Číslo bank. účtu', 6, 51),
(52, 0, '2013-03-03 11:57:30', '2013-03-03 11:57:30', 'Dodavatel je plátce DPH.', 6, 52),
(53, 0, '2013-03-03 11:57:44', '2013-03-03 11:57:44', 'Datum vystavení', 6, 53),
(54, 0, '2013-03-03 11:58:19', '2013-03-03 11:58:19', 'Sazba DPH', 6, 54),
(55, 0, '2013-03-03 11:58:33', '2013-03-03 11:58:33', 'Výše DPH', 6, 55),
(56, 0, '2013-03-03 11:59:13', '2013-03-03 11:59:13', 'K zaplacení', 6, 56),
(57, 0, '2013-03-03 12:02:33', '2013-05-04 17:05:11', 'Upozornění: Nejedná se o daňový doklad. Daňový doklad Vám vystavíme při expedici/dodání zboží.\r\nZákazník při objednání zboží souhlasil s obchodními podmínkami na stránkách www.papiroverucniky.cz', 6, 57),
(58, 0, '2013-03-03 12:05:16', '2013-03-03 12:05:16', 'Variabilní symbol', 6, 58),
(59, 0, '2013-03-28 18:04:10', '2013-05-04 17:24:44', 'Celkem bez DPH', 6, 59),
(60, 0, '2013-03-28 18:05:33', '2013-03-28 18:05:33', 'DPH', 6, 60),
(61, 0, '2013-04-11 16:31:19', '2013-04-11 16:31:19', 'Faktura', 6, 61),
(62, 0, '2013-04-12 13:10:11', '2013-04-12 13:10:11', 'Žádné objednávky', 6, 62),
(63, 0, '2013-04-20 22:12:10', '2013-04-20 22:12:10', 'Objednávka byla úspěšně dokončena', 6, 63),
(64, 0, '2013-04-20 22:13:04', '2013-06-17 16:57:23', 'Děkujeme Vám za nákup. V současné době se Vaše objednávka vyřizuje, budeme Vás následně informovat o její expedici. Kopii objednávky jsme odeslali také na email!', 6, 64),
(65, 0, '2013-04-20 22:16:02', '2013-04-20 22:23:08', 'Vytisknout objednávku ?!', 6, 65),
(66, 0, '2013-04-20 22:23:31', '2013-04-20 22:23:31', 'Objednávka', 6, 66),
(67, 0, '2013-04-23 22:08:54', '2013-12-18 18:40:23', 'Fakturujeme Vám za níže objednané zboží. Ceny jsou smluvní dle našeho ceníku a jsou uvedeny v CZK.', 6, 67),
(68, 0, '2013-04-24 10:51:17', '2013-04-24 10:51:17', 'Daňový doklad - Faktura č.', 6, 68),
(69, 0, '2013-04-24 11:29:29', '2013-04-24 11:29:29', 'Faktutujeme Vám námi dodané produkty. Ceny jsou smluvní dle našeho ceníku a jsou uvedeny v CZK.', 6, 69),
(70, 0, '2013-04-24 11:30:26', '2013-04-24 11:30:26', 'Mezisoučet', 6, 70),
(71, 0, '2013-04-24 11:38:56', '2013-04-24 11:38:56', 'Datum splatnosti', 6, 71),
(72, 0, '2013-04-24 11:39:17', '2013-04-24 11:39:17', 'Zdanitelné plnění', 6, 72),
(73, 0, '2013-04-24 11:43:11', '2013-04-24 11:43:11', 'Přijatá objednávka č.', 6, 73),
(74, 0, '2013-04-28 17:27:06', '2013-04-28 17:27:06', 'Opravdu si přejete odstranit veškeré zboží z košíku??', 6, 74),
(75, 0, '2013-04-29 23:17:56', '2013-04-29 23:17:56', 'Odhlásit se', 6, 75),
(76, 0, '2013-04-29 23:18:15', '2013-04-29 23:18:15', 'Můj účet', 6, 76),
(77, 0, '2013-04-29 23:20:26', '2013-04-29 23:20:26', 'Přihlásit se', 6, 77),
(78, 0, '2013-04-29 23:20:55', '2013-04-29 23:20:55', 'Registrace', 6, 78),
(79, 0, '2013-04-29 23:25:49', '2013-04-29 23:25:49', 'Zvolte způsob dopravy', 6, 79),
(80, 0, '2013-04-29 23:26:08', '2013-04-29 23:26:08', 'Zvolte způsob platby', 6, 80),
(81, 0, '2013-04-29 23:27:05', '2013-04-29 23:27:05', 'Telefon', 6, 81),
(82, 0, '2013-04-29 23:28:10', '2013-04-29 23:28:10', 'Vaše poznámka', 6, 82),
(83, 0, '2013-05-12 01:19:33', '2013-05-12 01:19:33', 'Výše objednávky splňuje podmínky pro dopravné ZDARMA!', 6, 83),
(84, 0, '2013-05-12 01:23:34', '2013-05-12 01:53:20', 'Přepravné ZDARMA u objednávek nad 2 000 Kč. Do této částky Vám zbývá <strong>%s Kč</strong>. (Ceny jsou uvedeny bez DPH)', 6, 84),
(85, 0, '2013-05-12 03:44:48', '2013-05-12 03:44:48', 'ZDARMA', 6, 85),
(86, 0, '2013-05-12 04:29:36', '2013-05-12 04:30:55', 'Poznámka od zákazníka', 6, 86),
(87, 0, '2013-05-12 04:33:31', '2013-05-12 04:33:31', 'Kontaktní údaje odběratele / Vyřizuje', 6, 87),
(88, 0, '2013-05-12 04:50:47', '2013-05-12 04:50:47', 'Objednávka číslo', 6, 88),
(89, 0, '2013-05-28 20:14:15', '2013-05-28 20:15:01', 'Úvod', 6, 89),
(90, 0, '2013-05-29 20:01:04', '2013-05-29 20:01:04', 'Proforma faktura č.', 6, 90),
(91, 0, '2013-05-29 20:45:06', '2013-05-29 20:45:06', 'Upozornění: Nejedná se o daňový doklad. Daňový doklad Vám vystavíme při expedici/dodání zboží.\r\nZákazník při objednání zboží souhlasil s obchodními podmínkami na stránkách www.papiroverucniky.cz', 6, 91),
(92, 0, '2013-06-02 18:38:56', '2013-06-02 18:39:54', 'Faktura č.', 6, 92),
(93, 0, '2013-06-08 21:50:06', '2013-06-08 21:50:06', 'sestupně', 6, 93),
(94, 0, '2013-06-08 21:50:45', '2013-06-08 21:50:45', 'Vzestupně', 6, 94),
(95, 0, '2013-06-17 19:27:14', '2013-06-17 19:27:14', 'Vyplňte prosím všechna povinná pole!', 6, 95),
(96, 0, '2013-06-17 19:31:09', '2013-07-24 18:59:21', 'Reklamační formulář byl úspěšně odeslán. O jeho vyřízení Vás budeme informovat!', 6, 96),
(97, 0, '2013-06-17 19:52:29', '2013-06-17 19:52:29', 'Vyberte obrázek poškozeného zboží / závady! Děkujeme', 6, 97),
(98, 0, '2013-07-22 19:43:10', '2013-07-22 19:43:10', '', 6, 98),
(99, 0, '2013-07-24 19:00:03', '2013-07-24 19:00:03', 'Formulář byl úspěšně odeslán.', 6, 99),
(100, 0, '2014-07-16 23:16:05', '2014-07-16 23:16:05', 'Rozpis DPH', 6, 100),
(101, 0, '2014-07-16 23:16:27', '2014-07-16 23:16:27', 'Základ DPH', 6, 101),
(102, 0, '2015-02-07 01:32:50', '2015-02-07 01:32:50', 'Běžná cena', 6, 102),
(103, 0, '2015-03-12 22:54:43', '2015-03-12 22:54:43', 'Původní cena', 6, 103),
(104, 0, '2017-08-23 09:06:36', '2017-08-23 09:06:36', 'Do košíku', 6, 104),
(105, 0, '2017-08-23 09:06:47', '2017-08-23 09:08:00', 'skladem', 6, 105),
(106, 0, '2017-08-23 09:07:14', '2017-08-23 09:07:14', 'Výrobce', 6, 106),
(107, 0, '2017-08-23 09:08:26', '2017-08-23 09:08:26', 'Cena bez DPH', 6, 107),
(108, 0, '2017-08-23 09:08:41', '2017-08-23 09:08:41', 'Cena s DPH', 6, 108),
(109, 0, '2017-08-23 09:09:08', '2017-08-23 09:09:08', 'Ušetříte', 6, 109),
(110, 0, '2017-08-23 09:09:30', '2017-08-23 09:09:30', 'skladem do týdne', 6, 110),
(111, 0, '2017-08-23 09:09:44', '2017-08-23 09:09:44', '2-14 dní', 6, 111),
(112, 0, '2017-08-23 09:10:09', '2017-08-23 09:10:09', 'Další produkty', 6, 112),
(113, 0, '2017-08-23 09:10:35', '2017-08-23 09:10:35', 'Hledej ve zboží', 6, 113),
(114, 0, '2017-08-23 09:11:27', '2017-08-23 09:11:27', 'Do 3 dnů', 6, 114),
(115, 0, '2017-10-05 20:59:25', '2017-10-05 20:59:25', 'zobrazeno', 6, 115),
(116, 0, '2017-10-05 21:02:04', '2017-10-05 21:02:04', 'Katalogové umístění', 6, 116),
(117, 0, '2017-10-05 21:03:15', '2017-10-05 21:03:15', 'Přidat do oblíbených', 6, 117),
(118, 0, '2017-12-11 10:57:33', '2017-12-11 10:57:33', 'Přejít do pokladny', 6, 118),
(119, 0, '2017-12-13 08:29:39', '2017-12-13 08:29:39', 'sleva', 6, 119),
(120, 0, '2017-12-14 19:39:40', '2017-12-14 19:39:40', 'Celkem s DPH', 6, 120),
(121, 0, '2017-12-14 19:40:15', '2017-12-14 19:40:15', 'Volba dopravy', 6, 121),
(122, 0, '2017-12-14 19:40:37', '2017-12-14 19:40:37', 'Volba platby', 6, 122),
(123, 0, '2017-12-14 19:41:02', '2017-12-14 19:41:02', 'Město', 6, 123),
(124, 0, '2017-12-14 19:41:25', '2017-12-14 19:41:25', 'PSČ', 6, 124),
(125, 0, '2017-12-14 19:41:59', '2017-12-14 19:41:59', 'Zvolený způsob dopravy', 6, 125),
(126, 0, '2017-12-14 19:42:21', '2017-12-14 19:42:21', 'Zvolený způsob platby', 6, 126),
(127, 0, '2017-12-14 19:42:51', '2017-12-14 19:42:51', 'Zboží dodat na jinou adresu', 6, 127),
(128, 0, '2017-12-14 19:43:01', '2017-12-14 19:43:01', 'Změnit', 6, 128),
(129, 0, '2017-12-14 19:44:24', '2017-12-14 19:44:24', 'seřadit dle', 6, 129),
(130, 0, '2017-12-14 19:44:46', '2017-12-14 19:44:46', 'Názvu', 6, 130),
(131, 0, '2017-12-14 19:44:58', '2017-12-14 19:44:58', 'Ceny', 6, 131),
(132, 0, '2017-12-14 19:45:14', '2017-12-14 19:45:14', 'Výrobce', 6, 132),
(133, 0, '2017-12-14 20:19:04', '2017-12-14 20:19:04', 'položek', 6, 133),
(134, 0, '2017-12-14 20:19:14', '2017-12-14 20:19:14', 'z', 6, 134),
(135, 0, '2017-12-14 20:19:27', '2017-12-14 20:19:27', 'další', 6, 135),
(136, 0, '2017-12-14 20:19:49', '2017-12-14 20:19:49', 'předchozí', 6, 136),
(137, 0, '2017-12-14 22:09:22', '2017-12-14 22:09:22', 'Objednávka dokončena a odeslána', 6, 137),
(138, 0, '2017-12-20 21:23:52', '2017-12-20 21:23:52', 'Další produkty systému', 6, 138),
(139, 0, '2018-02-08 09:46:19', '2018-02-08 09:46:19', 'Tento web používá soubory cookie, které nám pomáhají zajistit lepší služby.', 6, 139),
(140, 0, '2018-02-08 09:46:55', '2018-02-08 09:48:17', 'Více informací', 6, 140),
(141, 0, '2018-02-08 09:47:22', '2018-02-08 09:47:22', 'Souhlasím', 6, 141);
