...
class RadekDokladuTemplate extends Template {
	...
	//	$this->_attributtes["order"] = array("type" => "int(11)", "default" => "0");
		...
		$this->_attributtes["sleva"] = array("type" => "decimal(12,2)");

	//	$this->_attributtes["celkem"] = array("type" => "numeric(12,2)", "stereotyp" => "vypoctova", "default" => "\$this->qty * \$this->price");
		$this->_attributtes["celkem"] = array("type" => "decimal(12,2)", "stereotyp" => "vypoctova", "default" => "vypocetCelkoveCenyRadkuDokladu(\$this)");

		$this->_attributtes["price_sdani"] = array("type" => "decimal(12,2)");
		$this->_attributtes["celkem_sdani"] = array("type" => "decimal(12,2)", "stereotyp" => "vypoctova", "default" => "vypocetCelkoveCenyRadkuDokladuSDani(\$this)");
