...
abstract class DokladEntity extends Entity {
	...
	function __construct($entity = null, $lazyLoad = true)
	{
		...
		$this->metadata["platba_id"] = array("type" => "int(11)","default" => "NULL","reference" => "ShopPlatby");
		...
		$this->metadata["download_hash"] = array("type" => "varchar(50)","default" => "NULL");
	}
	#endregion
	...
	// int(11)
	protected $platba_id = NULL;
	protected $platba_idOriginal = NULL;

	protected $platbaShopPlatbyEntity;
	...
	// varchar(50)
	protected $download_hash = NULL;
	protected $download_hashOriginal = NULL;
	...
	protected function setPlatba_id($value)
	{
		...
		if (isCeleKladneCislo($value) && $this->lazyLoad) {
			$this->platbaShopPlatbyEntity = new ShopPlatbyEntity($value,false);
		} else {
			$this->platbaShopPlatbyEntity = null;
		}
	}
	// Getter platba_id
	...
	// Setter download_hash
	protected function setDownload_hash($value)
	{
		$this->download_hash = $value;
	}
	// Getter download_hash
	public function getDownload_hash()
	{
		return $this->download_hash;
	}
	// Getter download_hashOriginal
	public function getDownload_hashOriginal()
	{
		return $this->download_hashOriginal;
	}
	#endregion
