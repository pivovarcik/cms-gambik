...
abstract class PageVersionEntity extends Entity {
	...
	function __construct($entity = null, $lazyLoad = true)
	{
		...
		$this->metadata["canonical"] = array("type" => "varchar(255)","default" => "NULL");
	}
	#endregion
	...
	protected $canonicalOriginal = NULL;
	...
	// Setter canonical
	protected function setCanonical($value)
	{
	...
	// Getter canonicalOriginal
	public function getCanonicalOriginal()
	{
		return $this->canonicalOriginal;
	}
	#endregion
