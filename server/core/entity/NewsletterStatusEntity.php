...
class NewsletterStatusEntity extends Entity {
	...
	function __construct($entity = null, $lazyLoad = true)
	{
		...
		$this->metadata["newsletter_id"] = array("type" => "int(11)","default" => "NULL");
	}
	#endregion
	...
	// int(11)
	protected $newsletter_id = NULL;
	protected $newsletter_idOriginal = NULL;
	...
	{
		if (isInt($value) || is_null($value)) { $this->newsletter_id = $value; }
	}
