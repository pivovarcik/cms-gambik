...
abstract class PageEntity extends Entity {
	...
	function __construct($entity = null, $lazyLoad = true)
	{
		...
		$this->metadata["robots"] = array("type" => "tinyint(1)","default" => "1");
	}
	#endregion
	...
	// Getter robotsOriginal
	public function getRobotsOriginal()
	{
		return $this->robotsOriginal;
	}
	#endregion
