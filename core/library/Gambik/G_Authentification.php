...
class G_Authentification
{
	...
	private function _akcePoUspesnemPrihlaseni($userDetail)
	{
	...
	private function setUserData()
	{
		...
		$doba_relace = self::$casnaposledy + (time() - self::$casnaposledy);
	...
	public function checkNick($nick)
	{
		 ...
		 *		 		*/
		if (!$nick || $nick=="" || strlen($nick)< 3 || strlen($nick)> 17 || strtolower($nick) != StrTr(str_replace(" ","",strtolower($nick)),"áäčçďéěëíňóöřšťúůüýž","aaccdeeeinoorstuuuyz") ){ return FALSE; } else { return TRUE; }
	}
