...
class EntityGenerator {
	...
	private function generujApplicationTemplate()
	{
		...
		if (isset($TemplateClass->_attributtes)) {
			...
			//s	print_r($definition);
				if ($isPublic) {
					...
					if (isset($definition["type"]) && ("float" === substr(strtolower($definition["type"]),0,5) || "decimal" === substr(strtolower($definition["type"]),0,7))) {
