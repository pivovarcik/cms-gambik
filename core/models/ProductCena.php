...
class models_ProductCena extends G_Service{
	...
	//	print_r($params);
		...
		$query = "update  " . T_PRODUCT_CENA . " set isDeleted =0 where cenik_id = " . $params->cenik_id;
		//		print $query;
		$this->query($query);
	...
	public function getList(IListArgs $params=null)
	{
		...
		$this->setSelect("t1.*,pv.title as product_name,p.cislo as product_cislo,pc.name as cenik_name,pv.prodcena");
